...
thread_set_nice (int nice UNUSED) 
{
  /* Not yet implemented. */
	...
	thread_mlfqs_refresh (thread_current ());
	thread_yield ();
}
...
void check_thread(struct thread *t, void *aux ){
...
bool thread_compare(struct list_elem *a,struct list_elem *b, void *aux){
...
/*this is an atomic operation, and interruption should be disabled*/
void thread_refresh (struct thread *t){
  ...
  t->priority = t->initial_priority>lock_priority?t->initial_priority:lock_priority;
}

void thread_mlfqs_refresh_load (){
    ...
    e = list_next (e)){
 		...
 		if (t != idle_thread){
 			...
 			thread_mlfqs_refresh (t);
 		}
 	}

}

void thread_mlfqs_refresh (struct thread *t){
